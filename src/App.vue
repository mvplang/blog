<template>
  <div id="app" v-bind:class="[state]">
    <header class="header">
      <div class="box">
        <h1>Zhaoxing(二蛋)'s Blog</h1>
        <h3>A Passionate, Creative, and Devoted Front End developer</h3>
        <p class="socials">
          <a href="https://github.com/mvplang" target="_blank" class='icon github'></a>
          <a href="https://www.douban.com/people/31829297/" target="_blank" class='icon douban'></a>
          <a href="https://twitter.com/Erdan__"  target="_blank" class='icon twitter'></a>
        </p>
      </div>
 ...
 * {
 ...
 .header {
   ...
   width: 100%;
   height: 100%;
   background: url('./assets/pittsburgh.png') no-repeat center;
 ...
 p.socials > a.douban {
   background-image: url('./assets/douban-logo.png');
 }
 p.socials > a.twitter {
